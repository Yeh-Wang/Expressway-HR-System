...
public class Generator {
    ...
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/hrm_database?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSl=true";
    private static final String JDBC_USER_NAME = "root";
    private static final String JDBC_PASSWORD = "256817";

    // 包名和模块名
    private static final String PACKAGE_NAME = "org.yeh.wang";

    // 表名,多个表使用英文逗号分割
//    private static final String[] TBL_NAMES = {"apply_feedback","authority","check_sheet","daily_punch","exam_info","exam_paper_info","perform_type","performance_review","public_notice","re_pun_info","role_auth","role_info","staff_info","study_record","study_src","train_grade_info","train_info","user_info","user_role"};
    private static final String[] TBL_NAMES = {"need_duty"};
